...
<section class="section">
    ...
    <div class="statistics-period">
        ...
        <div class="note">
            <p class="card-title"><?= $most_sales_product_last_month ?></p>
            <p class="small-desc between-ele">
                <?= $destSellingProductLastMonth ? $destSellingProductLastMonth->Name : '' ?>
                <span><?= $destSellingProductLastMonth ? $destSellingProductLastMonth->repeated : '' ?> <?= $pieces ?></span>
            </p>
        ...
        <div class="note">
            <p class="card-title"><?= $most_sales_product_previous_month ?></p>
            <p class="small-desc between-ele">
                <?= $destSellingProductPreviousMonth ? $destSellingProductPreviousMonth->Name : '' ?>
                <span><?= $destSellingProductPreviousMonth ? $destSellingProductPreviousMonth->repeated : ''?> <?= $pieces ?></span>
            </p>
            <p class="distribution">
