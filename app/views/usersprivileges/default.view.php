                        ...
                        foreach ($privileges as $privilege) {
                            ...
                            <tr class="row-each-employee">
                                ...
                                <td class="controller-btns">
                                    <a href="employee/edit/<?= $privilege->PrivilegeId ?>"><i class="fas fa-edit"></i></a>
                                    <a href="employee/delete/<?= $privilege->PrivilegeId ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
