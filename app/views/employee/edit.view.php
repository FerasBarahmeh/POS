        ...
        <form method="POST" class="add-employee" enctype="application/x-www-form-urlencoded">
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="name" id="name" placeholder="Write Name Employee Here" value="<?= $employee->name ?>" maxlength="50" required>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="number" name="age" id="age" value="<?= $employee->age ?>" min="18" max="100" required>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="address" id="address" value="<?= $employee->address ?>" placeholder="Write Address" required>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="number" step="0.01" name="salary" value="<?= $employee->salary ?>" id="salary" min="100" max="9000" required>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="number" step="0.01" name="tax" value="<?= $employee->tax ?>" id="tax" min="0" max="5" required>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="submit" name="edit-employee"  value="save">
                        </td>
                    </tr>
                </table>
            </fieldset>
