<?php
$content["file_success_add_file"]               = " بنجاح " . "<b class='bold-font'>%s</b>" . "تم اضافة الملف ";
$content["file_error_when_upload"]               = " يرجى المحاولة مرة اخرى " . " <b class='bold-font'>%s</b> " . "عذرا حدث خطأ اثناء رفع الملف ";
